...
@Schema({ _id: false, versionKey: false })
class UnderwritingVerificationEvidence {
...
@Schema({ _id: false, versionKey: false })
class UnderwritingVerificationSnapshot {
  @Prop({ type: String, trim: true, default: null })
  ...
  @Prop({ type: UnderwritingVerificationEvidence, required: true })
  evidence: UnderwritingVerificationEvidence;
...
export class UnderwritingCase {
  ...
  @Prop({ type: UnderwritingVerificationSnapshot, default: null })
  verificationSnapshot?: UnderwritingVerificationSnapshot | null;
